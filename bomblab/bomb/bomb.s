...
0000000000400d70 <frame_dummy>:
  400d70:	48 83 3d 90 20 20 00 	cmpq   $0x0,0x202090(%rip)        # 602e08 <__JCR end__>
  400d77:	00 
...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers> ;读入6个数字，存到rsp
  ...
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>  ; rbx<rbp
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>  ; 结束这个循环 ； 备注：循环证明这6个数为q=2的等比数列
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx         ; rbx = rsp + 4
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp        ; 设置rbp为循环界限
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi           ;0x4025cf存放scanf参数
  ...
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax           ;将输入的第一个数存到eax
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax      ; 之前已调用mov $0xe,%edx
  400fd4:	29 f0                	sub    %esi,%eax      ; mov $0x0, %esi
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   ; ecx = rax + rsi = rax + 0 = eax+
  400fe2:	39 f9                	cmp    %edi,%ecx            ; 比较ecx(7)和a1
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  ; 7<=a1时, 结束
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx      ; edx = rcx-1
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>       ; edx=rcx-1, esi=0, edi=a1
...
000000000040100c <phase_4>:
  ...
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi     ; scanf("%d %d") 读入两个数字
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)         ; 输入的第一个数字(记为a1)与0xe比较
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi         ; a1->edi
  401048:	e8 81 ff ff ff       	call   400fce <func4>         ; edx=0xe, esi=0, edi=a1
...
0000000000401062 <phase_5>:
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx     ; 读入字符串
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx              ; ebx->edx, 保留低4位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx    ; edx = array.3349[edx]
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  ; 将数组拷贝到rsp+0x10 (rsp+0x10)[rax]=array.3349[key[rax]]
  4010a4:	48 83 c0 01          	add    $0x1,%rax              ; rax即为i
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi         ; key!: 66 6c 79 65 72 73->9 f e 5 6 7->69(i) 6f(o) 6e(n) 65(e) 66(f) 67(g)
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers>  ;读取6个数字，保存到(%rsp)
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d             ; r12d疑似i
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>  ;eax<5
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax     ; eax = number[r12d]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>  ; number[r13] != number[r12d]
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>  ; 循环， 比较后5个数是否等于a[r13],相等则会引爆
  40114d:	49 83 c5 04          	add    $0x4,%r13              
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi        ; rsi为字符串边界
  401158:	4c 89 f0             	mov    %r14,%rax
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx              ; for3 begin
  401162:	2b 10                	sub    (%rax),%edx
  401164:	89 10                	mov    %edx,(%rax)
  401166:	48 83 c0 04          	add    $0x4,%rax
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  ; for3 end 循环后 number[i]=7-number[i]
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>  ; jmp
  ;--------------------------for4 begin---------------------------------------  
  ; for4将number[0]~[5]数据对应的node的地址存储到rsp+0x20~rsp+0x48中
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx         ; rdx = (edx+8) edx初值0x6032d0
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax              
  40117f:	75 f5                	jne    401176 <phase_6+0x82>  ; number[rsi/4] != eax
  401181:	eb 05                	jmp    401188 <phase_6+0x94>  ; 找到ecx存放在哪一个node中（即rdx地址）
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) 
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>  ; rsi+=4, rsi=18时结束循环
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx     ; ecx = number[rsi/4]
  40119a:	83 f9 01             	cmp    $0x1,%ecx              
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  ; num[rsi/4] <= 1(注意， 前面for3处理过数据)
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  ;---------------------------for4 end--------------------------------------
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx        ; rbx = (rsp+20), 即number[0]在node中的地址
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax        ; rax = 0x28+rsp (address)
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi        ; rsi = 0x50+rsp (address)
  ...
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>  ; rax遍历结束，退出循环
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  ;--------------------------for5 end---------------------------------------  
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)         ; 尾结点
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>  ; (rbx)>=(rbx+8)
...
0000000000401204 <fun7>:      ; esi:输入的数字, rdi:0x24
  401204:	48 83 ec 08          	sub    $0x8,%rsp
  401208:	48 85 ff             	test   %rdi,%rdi
  40120b:	74 2b                	je     401238 <fun7+0x34> ; rdi==0
  40120d:	8b 17                	mov    (%rdi),%edx        
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c> ; edi(0x24)<=esi
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi     ; 跳到地址
  401217:	e8 e8 ff ff ff       	call   401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39> ; edi==esi
...
0000000000401242 <secret_phase>:
  ...
  401252:	48 89 c7             	mov    %rax,%rdi              ; rax保存输入的string
  401255:	e8 76 f9 ff ff       	call   400bd0 <strtol@plt>    ; string to long
  40125a:	48 89 c3             	mov    %rax,%rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax        ; rax--
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax            
  401265:	76 05                	jbe    40126c <secret_phase+0x2a> ; rax<0x3e8(1000)否则boom！
  401267:	e8 ce 01 00 00       	call   40143a <explode_bomb> 
  40126c:	89 de                	mov    %ebx,%esi               ; esi=输入数字
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi          ; (edi)=0x24
  401273:	e8 8c ff ff ff       	call   401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax               ; 经过fun7后， eax必须等于0x2
...
00000000004015c4 <phase_defused>:
  ...
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings> ; 只有phase6才能进入
