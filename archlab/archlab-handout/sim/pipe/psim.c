                ...
                int argc, char *argv[])
{
    ...
    if (argc != 1)
    {
        interp->resultDontUse = "No arguments allowed";
        return TCL_ERROR;
    }
    sim_reset();
    if (post_load_mem)
    ...
    interp->resultDontUse = stat_name(STAT_AOK);
    return TCL_OK;
}
                   ...
                   int argc, char *argv[])
{
    ...
    if (argc != 2)
    {
        interp->resultDontUse = "One argument required";
        return TCL_ERROR;
    }
                   ...
                   int argc, char *argv[])
{
    FILE *data_file;
    word_t word_count = 0;
    interp->resultDontUse = "Not implemented";
    return TCL_ERROR;
              ...
              int argc, char *argv[])
{
    ...
    if (argc > 2)
    {
        interp->resultDontUse = "At most one argument allowed";
        return TCL_ERROR;
    }
    if (argc >= 2 &&
    ...
    interp->resultDontUse = stat_name(status);
    return TCL_OK;
}
